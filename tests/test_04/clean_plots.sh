#!/bin/bash
rm -f TC4_SC0_DepoThick_vs_distance.png
rm -f TC4_SC0_Ash3d_CloudLoad_t016.00hrs.png
rm -f TC4_SC0_Ash3d_Deposit____final.png
rm -f TC4_SC0_vprof_0002.png
rm -f TC4_SC1_Ash3d_CloudLoad_t016.00hrs.png
rm -f TC4_SC1_Ash3d_Deposit____final.png
rm -f TC4_SC1_vprof_0002.png
