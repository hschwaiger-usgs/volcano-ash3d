...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do while(iostatus == 0)
        ...
        if(substr_pos == 1)then
          ...
          if(trim(adjustl(mod_name)) == 'RESETPARAMS')then
            exit
          endif
        endif
1104    format(7x,a20)
      ...
      do i = 1,iparam
        if (pname(i) == 'MagmaDensity') then
          ...
          if (pvalue(i) <= 0.0_ip)then
            ...
            stop 1
          elseif (pvalue(i) > 10000.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_info)then
        ...
        elseif (pname(i) == 'DepositDensity') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'LAM_GS_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
            ...
            stop 1
          elseif (pvalue(i) > 1000.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_info)then
        ...
        elseif (pname(i) == 'AIRBORNE_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'DEPRATE_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'CLOUDCON_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'CLOUDCON_GRID_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
            ...
            stop 1
          elseif (pvalue(i) > 1.0e-1_ip)then
            do io=1,2;if(VB(io) <= verbosity_info)then
        ...
        elseif (pname(i) == 'CLOUDLOAD_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'THICKNESS_THRESH') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'StopValue_FracAshDep') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'DBZ_THRESH') then
          ! error-checking
          if (pvalue(i) >= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
          ...
          DBZ_THRESH = pvalue(i)
        elseif (pname(i) == 'Imp_fac') then
          ! error-checking
          if (pvalue(i) < 0.0_ip.or.pvalue(i) > 1.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
          ...
          Imp_fac = pvalue(i)
        elseif (pname(i) == 'Imp_DT_fac') then
          ! error-checking
          if (pvalue(i) < 0.5_ip.or.pvalue(i) > 4.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
          ...
          Imp_DT_fac = pvalue(i)
        elseif (pname(i) == 'VelMod_umb') then
          if(abs(pvalue(i)-1.0_ip) < EPS_SMALL)then
            VelMod_umb = 1
          elseif(abs(pvalue(i)-2.0_ip) < EPS_SMALL)then
            VelMod_umb = 2
          else
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'lambda_umb') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'N_BV_umb') then
          ...
          N_BV_umb = pvalue(i)
        elseif (pname(i) == 'k_entrainment_umb') then
          ! error-checking
          if (pvalue(i) <= 0.0_ip)then
            do io=1,2;if(VB(io) <= verbosity_error)then
        ...
        elseif (pname(i) == 'SuzK_umb') then
          ...
          SuzK_umb = pvalue(i)
        elseif (pname(i) == 'useMoistureVars') then
          ! error-checking
          ! This should either be 0 for .false. or 1 for .true.
          ! but we read the value as a float
          if(abs(pvalue(i)) < EPS_SMALL)then
            useMoistureVars = .false.
          elseif(abs(pvalue(i)-1.0_ip) < EPS_SMALL)then
        ...
        elseif (pname(i) == 'useWindVars') then
          ! error-checking
          ! This should either be 0 for .false. or 1 for .true.
          ! but we read the value as a float
          if(abs(pvalue(i)) < EPS_SMALL)then
        ...
        elseif (pname(i) == 'useOutprodVars') then
          ! error-checking
          ! This should either be 0 for .false. or 1 for .true.
          ! but we read the value as a float
          if(abs(pvalue(i)) < EPS_SMALL)then
        ...
        elseif (pname(i) == 'useRestartVars') then
          ! error-checking
          ! This should either be 0 for .false. or 1 for .true.
          ! but we read the value as a float
          if(abs(pvalue(i)) < EPS_SMALL)then
        ...
        elseif (pname(i) == 'useVz_rhoG') then
          ! error-checking
          ! This should either be 0 for .false. or 1 for .true.
          ! but we read the value as a float
          if(abs(pvalue(i)) < EPS_SMALL)then
