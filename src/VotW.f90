...
50    format(a8,a42,a31,f21.3,a18,f19.3,a18,a15,a18)
      ...
      i=i+1; volcLat(i)= -2.380; volcLon(i)=147.350; volcElev(i)=  270;  volcLoc(i)="Admiralty Is-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0500-01="; volcName(i)="St. Andrew Strait              ";
      i=i+1; volcLat(i)= -2.570; volcLon(i)=147.280; volcElev(i)=  254;  volcLoc(i)="Admiralty Is-SW Paific       ";
             volcESP_Code(i)="M0"; volcID(i)="0500-02-"; volcName(i)="Baluan                         ";
      i=i+1; volcLat(i)= -3.030; volcLon(i)=147.780; volcElev(i)=-1300;  volcLoc(i)="Admiralty Is-SW Paific       ";
      ...
      i=i+1; volcLat(i)= -3.125; volcLon(i)=152.642; volcElev(i)=  700;  volcLoc(i)="New Ireland-SW Pacfic        ";
             volcESP_Code(i)="M0"; volcID(i)="0504-01="; volcName(i)="Lihir                          ";
      i=i+1; volcLat(i)= -4.080; volcLon(i)=153.650; volcElev(i)=  450;  volcLoc(i)="New Ireland-SW Pacfic        ";
             volcESP_Code(i)="S0"; volcID(i)="0504-02="; volcName(i)="Ambitle                        ";
      i=i+1; volcLat(i)= -5.830; volcLon(i)=154.930; volcElev(i)= 2200;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0505-00-"; volcName(i)="Tore                           ";
      i=i+1; volcLat(i)= -6.092; volcLon(i)=155.225; volcElev(i)= 1544;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0505-011"; volcName(i)="Billy Mitchell                 ";
      i=i+1; volcLat(i)= -5.920; volcLon(i)=154.980; volcElev(i)= 2715;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0505-01="; volcName(i)="Balbi                          ";
      i=i+1; volcLat(i)= -6.442; volcLon(i)=155.608; volcElev(i)= 2210;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0505-021"; volcName(i)="Takuan Group                   ";
      i=i+1; volcLat(i)= -6.140; volcLon(i)=155.195; volcElev(i)= 1750;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S1"; volcID(i)="0505-02="; volcName(i)="Bagana                         ";
      i=i+1; volcLat(i)= -6.520; volcLon(i)=155.620; volcElev(i)= 1887;  volcLoc(i)="Bougainville-SW Paific       ";
             volcESP_Code(i)="S0"; volcID(i)="0505-03="; volcName(i)="Loloru                         ";
      i=i+1; volcLat(i)= -8.750; volcLon(i)=157.030; volcElev(i)= -700;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="U0"; volcID(i)="0505-052"; volcName(i)="Kana Keoki                     ";
      i=i+1; volcLat(i)= -8.830; volcLon(i)=157.170; volcElev(i)=    0;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="U0"; volcID(i)="0505-053"; volcName(i)="Coleman Seamount               ";
      i=i+1; volcLat(i)= -8.292; volcLon(i)=156.520; volcElev(i)=  335;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="S0"; volcID(i)="0505-05="; volcName(i)="Simbo                          ";
      i=i+1; volcLat(i)= -8.920; volcLon(i)=158.030; volcElev(i)= -240;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="U0"; volcID(i)="0505-061"; volcName(i)="Unnamed                        ";
      i=i+1; volcLat(i)= -9.350; volcLon(i)=159.730; volcElev(i)= 1000;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="S0"; volcID(i)="0505-062"; volcName(i)="Gallego                        ";
      i=i+1; volcLat(i)= -9.020; volcLon(i)=157.950; volcElev(i)=  -20;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="M1"; volcID(i)="0505-06="; volcName(i)="Kavachi                        ";
      i=i+1; volcLat(i)= -9.130; volcLon(i)=159.820; volcElev(i)=  485;  volcLoc(i)="Solomon Is-SW Paciic         ";
             volcESP_Code(i)="S2"; volcID(i)="0505-07="; volcName(i)="Savo                           ";
      i=i+1; volcLat(i)=-10.380; volcLon(i)=165.800; volcElev(i)=  851;  volcLoc(i)="Santa Cruz Is-SW Pcific      ";
      ...
      i=i+1; volcLat(i)= 13.430; volcLon(i)= 94.280; volcElev(i)=  710;  volcLoc(i)="Andaman Is-Indian            ";
             volcESP_Code(i)="S0"; volcID(i)="0600-001"; volcName(i)="Narcondum                      ";
      i=i+1; volcLat(i)= 12.278; volcLon(i)= 93.858; volcElev(i)=  354;  volcLoc(i)="Andaman Is-Indian            ";
      ...
      i=i+1; volcLat(i)=  2.300; volcLon(i)=125.370; volcElev(i)=  725;  volcLoc(i)="Sangihe Is-Indonesa          ";
             volcESP_Code(i)="S1"; volcID(i)="0607-01="; volcName(i)="Ruang                          ";
      i=i+1; volcLat(i)=  2.780; volcLon(i)=125.400; volcElev(i)= 1784;  volcLoc(i)="Sangihe Is-Indonesa          ";
             volcESP_Code(i)="S1"; volcID(i)="0607-02="; volcName(i)="Karangetang                    ";
      i=i+1; volcLat(i)=  3.138; volcLon(i)=125.491; volcElev(i)=   -5;  volcLoc(i)="Sangihe Is-Indonesa          ";
             volcESP_Code(i)="S1"; volcID(i)="0607-03="; volcName(i)="Banua Wuhu                     ";
      i=i+1; volcLat(i)=  3.670; volcLon(i)=125.500; volcElev(i)= 1320;  volcLoc(i)="Sangihe Is-Indonesa          ";
             volcESP_Code(i)="S1"; volcID(i)="0607-04="; volcName(i)="Awu                            ";
      i=i+1; volcLat(i)=  3.970; volcLon(i)=124.170; volcElev(i)=-5000;  volcLoc(i)="Sangihe Is-Indonesa          ";
             volcESP_Code(i)="U0"; volcID(i)="0607-05="; volcName(i)="Unnamed                        ";
      i=i+1; volcLat(i)=  1.830; volcLon(i)=127.830; volcElev(i)=  318;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="M0"; volcID(i)="0608-001"; volcName(i)="Tarakan                        ";
      i=i+1; volcLat(i)=  1.680; volcLon(i)=127.880; volcElev(i)= 1335;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S1"; volcID(i)="0608-01="; volcName(i)="Dukono                         ";
      i=i+1; volcLat(i)=  1.630; volcLon(i)=127.670; volcElev(i)= 1035;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-02-"; volcName(i)="Tobaru                         ";
      i=i+1; volcLat(i)=  1.488; volcLon(i)=127.630; volcElev(i)= 1325;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S1"; volcID(i)="0608-03="; volcName(i)="Ibu                            ";
      i=i+1; volcLat(i)=  1.380; volcLon(i)=127.530; volcElev(i)= 1635;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S1"; volcID(i)="0608-04="; volcName(i)="Gamkonora                      ";
      i=i+1; volcLat(i)=  1.080; volcLon(i)=127.420; volcElev(i)= 1130;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-051"; volcName(i)="Jailolo                        ";
      i=i+1; volcLat(i)=  0.900; volcLon(i)=127.320; volcElev(i)=  630;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="M0"; volcID(i)="0608-052"; volcName(i)="Hiri                           ";
      i=i+1; volcLat(i)=  1.250; volcLon(i)=127.470; volcElev(i)=  979;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-05="; volcName(i)="Todoko-Ranu                    ";
      i=i+1; volcLat(i)=  0.658; volcLon(i)=127.400; volcElev(i)= 1730;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-061"; volcName(i)="Tidore                         ";
      i=i+1; volcLat(i)=  0.570; volcLon(i)=127.400; volcElev(i)=  308;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-062"; volcName(i)="Mare                           ";
      i=i+1; volcLat(i)=  0.450; volcLon(i)=127.400; volcElev(i)=  950;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-063"; volcName(i)="Moti                           ";
      i=i+1; volcLat(i)=  0.800; volcLon(i)=127.330; volcElev(i)= 1715;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S1"; volcID(i)="0608-06="; volcName(i)="Gamalama                       ";
      i=i+1; volcLat(i)=  0.070; volcLon(i)=127.420; volcElev(i)=  422;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-071"; volcName(i)="Tigalalu                       ";
      i=i+1; volcLat(i)= -0.530; volcLon(i)=127.480; volcElev(i)= 1030;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-072"; volcName(i)="Amasing                        ";
      i=i+1; volcLat(i)= -0.770; volcLon(i)=127.720; volcElev(i)=  900;  volcLoc(i)="Halmahera-Indonesi           ";
             volcESP_Code(i)="S0"; volcID(i)="0608-073"; volcName(i)="Bibinoi                        ";
      i=i+1; volcLat(i)=  0.320; volcLon(i)=127.400; volcElev(i)= 1357;  volcLoc(i)="Halmahera-Indonesi           ";
      ...
      i=i+1; volcLat(i)=  6.013; volcLon(i)=121.057; volcElev(i)=  811;  volcLoc(i)="Sulu Is-Philippine           ";
             volcESP_Code(i)="M0"; volcID(i)="0700-01="; volcName(i)="Jolo                           ";
      i=i+1; volcLat(i)=  6.113; volcLon(i)=124.892; volcElev(i)= 1824;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-011"; volcName(i)="Parker                         ";
      i=i+1; volcLat(i)=  5.400; volcLon(i)=125.375; volcElev(i)=  862;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-01="; volcName(i)="Balut                          ";
      i=i+1; volcLat(i)=  6.370; volcLon(i)=125.070; volcElev(i)= 2286;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-02="; volcName(i)="Matutum                        ";
      i=i+1; volcLat(i)=  7.382; volcLon(i)=126.047; volcElev(i)= 1080;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-031"; volcName(i)="Leonard Range                  ";
      i=i+1; volcLat(i)=  6.989; volcLon(i)=125.269; volcElev(i)= 2938;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-03="; volcName(i)="Apo                            ";
      i=i+1; volcLat(i)=  7.647; volcLon(i)=124.320; volcElev(i)= 1940;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-04="; volcName(i)="Makaturing                     ";
      i=i+1; volcLat(i)=  7.650; volcLon(i)=124.450; volcElev(i)= 2338;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-05="; volcName(i)="Latukan                        ";
      i=i+1; volcLat(i)=  7.950; volcLon(i)=124.800; volcElev(i)= 2824;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-061"; volcName(i)="Kalatungan                     ";
      i=i+1; volcLat(i)=  7.700; volcLon(i)=124.500; volcElev(i)= 2815;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S1"; volcID(i)="0701-06="; volcName(i)="Ragang                         ";
      i=i+1; volcLat(i)=  8.220; volcLon(i)=123.630; volcElev(i)= 2404;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-071"; volcName(i)="Malindang                      ";
      i=i+1; volcLat(i)=  8.770; volcLon(i)=124.980; volcElev(i)= 2450;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="M0"; volcID(i)="0701-072"; volcName(i)="Balatukan                      ";
      i=i+1; volcLat(i)=  7.877; volcLon(i)=125.068; volcElev(i)=  646;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-07="; volcName(i)="Musuan                         ";
      i=i+1; volcLat(i)=  9.203; volcLon(i)=124.673; volcElev(i)= 1552;  volcLoc(i)="Mindanao-Philippins          ";
             volcESP_Code(i)="S0"; volcID(i)="0701-08="; volcName(i)="Camiguin                       ";
      i=i+1; volcLat(i)=  9.593; volcLon(i)=125.520; volcElev(i)=  524;  volcLoc(i)="Mindanao-Philippins          ";
      ...
      i=i+1; volcLat(i)= 21.000; volcLon(i)=142.900; volcElev(i)=    0;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="0804-138"; volcName(i)="Unnamed                        ";
      i=i+1; volcLat(i)= 20.300; volcLon(i)=143.200; volcElev(i)=    0;  volcLoc(i)="Mariana Is-C Pacifc          ";
      ...
      i=i+1; volcLat(i)= 20.420; volcLon(i)=145.030; volcElev(i)= -137;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="0804-141"; volcName(i)="Ahyi                           ";
      i=i+1; volcLat(i)= 20.130; volcLon(i)=145.100; volcElev(i)=   -8;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-142"; volcName(i)="Supply Reef                    ";
      i=i+1; volcLat(i)= 20.020; volcLon(i)=145.220; volcElev(i)=  227;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="M0"; volcID(i)="0804-143"; volcName(i)="Maug Islands                   ";
      i=i+1; volcLat(i)= 20.538; volcLon(i)=144.896; volcElev(i)=  360;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S1"; volcID(i)="0804-14="; volcName(i)="Farallon de Pajaros            ";
      i=i+1; volcLat(i)= 19.671; volcLon(i)=145.406; volcElev(i)=  857;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-15="; volcName(i)="Asuncion                       ";
      i=i+1; volcLat(i)= 18.770; volcLon(i)=145.670; volcElev(i)=  965;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="M0"; volcID(i)="0804-16="; volcName(i)="Agrigan                        ";
      i=i+1; volcLat(i)= 18.130; volcLon(i)=145.800; volcElev(i)=  570;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="M2"; volcID(i)="0804-17="; volcName(i)="Pagan                          ";
      i=i+1; volcLat(i)= 17.600; volcLon(i)=145.830; volcElev(i)=  744;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-18="; volcName(i)="Alamagan                       ";
      i=i+1; volcLat(i)= 16.880; volcLon(i)=145.850; volcElev(i)=    0;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-191"; volcName(i)="Zealandia Bank                 ";
      i=i+1; volcLat(i)= 16.708; volcLon(i)=145.780; volcElev(i)=  538;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-192"; volcName(i)="Sarigan                        ";
      i=i+1; volcLat(i)= 17.307; volcLon(i)=145.845; volcElev(i)=  287;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S0"; volcID(i)="0804-19="; volcName(i)="Guguan                         ";
      i=i+1; volcLat(i)= 15.930; volcLon(i)=145.670; volcElev(i)= -127;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="0804-201"; volcName(i)="East Diamante                  ";
      i=i+1; volcLat(i)= 15.620; volcLon(i)=145.570; volcElev(i)= -230;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="0804-202"; volcName(i)="Ruby                           ";
      i=i+1; volcLat(i)= 16.350; volcLon(i)=145.670; volcElev(i)=  790;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="S2"; volcID(i)="0804-20="; volcName(i)="Anatahan                       ";
      i=i+1; volcLat(i)= 14.601; volcLon(i)=144.775; volcElev(i)= -517;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="0804-211"; volcName(i)="NW Rota-1                      ";
      i=i+1; volcLat(i)= 15.000; volcLon(i)=145.250; volcElev(i)=  -43;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="M0"; volcID(i)="0804-21="; volcName(i)="Esmeralda Bank                 ";
      i=i+1; volcLat(i)= 13.400; volcLon(i)=143.920; volcElev(i)=    0;  volcLoc(i)="Mariana Is-C Pacifc          ";
             volcESP_Code(i)="M0"; volcID(i)="0804-22-"; volcName(i)="Forecast Seamount              ";
      i=i+1; volcLat(i)= 13.250; volcLon(i)=144.020; volcElev(i)=-1230;  volcLoc(i)="Mariana Is-C Pacifc          ";
      ...
      i=i+1; volcLat(i)=-17.570; volcLon(i)=211.150; volcElev(i)=-1400;  volcLoc(i)="Society Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="1303-01-"; volcName(i)="Teahitia                       ";
      i=i+1; volcLat(i)=-17.642; volcLon(i)=211.400; volcElev(i)=-2100;  volcLoc(i)="Society Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="1303-02-"; volcName(i)="Rocard                         ";
      i=i+1; volcLat(i)=-18.320; volcLon(i)=211.330; volcElev(i)= -160;  volcLoc(i)="Society Is-C Pacifc          ";
             volcESP_Code(i)="U0"; volcID(i)="1303-03-"; volcName(i)="Moua Pihaa                     ";
      i=i+1; volcLat(i)=-17.870; volcLon(i)=211.930; volcElev(i)=  435;  volcLoc(i)="Society Is-C Pacifc          ";
      ...
      i=i+1; volcLat(i)=-28.980; volcLon(i)=219.750; volcElev(i)=  -39;  volcLoc(i)="Austral Is-C Pacifc          ";
      ...
      i=i+1; volcLat(i)= 71.080; volcLon(i)=351.830; volcElev(i)= 2277;  volcLoc(i)="Atlantic-N-Jan Mayn          ";
