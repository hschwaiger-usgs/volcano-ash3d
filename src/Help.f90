...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      write(outlog(io),1)' StopValue_FracAshDep = 0.99                                                                           '
      write(outlog(io),1)' DBZ_THRESH           = -2.0e+1                                                                        '
      write(outlog(io),1)' Imp_fac              = 0.5                                                                            '
      write(outlog(io),1)' Imp_DT_fac           = 4.0                                                                            '
      ...
      write(outlog(io),1)'1 1.0                         # Topofile format, smoothing radius                                      '
      write(outlog(io),1)'GEBCO_2023.nc                 # topofile name                                                          '
      ...
      write(outlog(io),1)'yes                         # use vertical variable diffusivity                                        '
      write(outlog(io),1)'4                           # boundary layer model                                                     '
      write(outlog(io),1)'3                           # free-air model                                                           '
      write(outlog(io),1)'0.4                         # vonKarman                                                                '
      write(outlog(io),1)'150.0                       # LambdaC                                                                  '
      write(outlog(io),1)'0.25                        # RI_CRIT                                                                  '
      write(outlog(io),1)'*******************************************************************************                        '
