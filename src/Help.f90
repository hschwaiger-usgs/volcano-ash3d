...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      write(outlog(io),1)'SYSTEM      = [gfortran] or ifort                                               '
      write(outlog(io),1)'              This controls which compiler to use and which libraries to link.  '
      write(outlog(io),1)'              If you use a different compiler than these two, you will have to  '
      write(outlog(io),1)'              edit the variables in the SYSTEM blocks to suit your system.      '
      ...
      write(outlog(io),1)'              to include -DNC3.                                                 '
      write(outlog(io),1)'                                                                                '
